...
export function UsersPage() {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          <button type="button" onClick={() => openEditModal(user)} className="rounded bg-brand-700 px-3 py-2 text-white">
            Editar meus dados
          </button>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4">
            <div className="w-full max-w-xl rounded-xl border border-slate-200 bg-white p-4">
              <div className="mb-3 flex items-center justify-between">
                <h3 className="text-lg font-semibold">Editar meu cadastro</h3>
              ...
              <form onSubmit={updateUser} className="grid gap-2">
                ...
                <button className="rounded bg-brand-700 px-3 py-2 text-white">Salvar alteracoes</button>
              </form>
            </div>
          </div>
        )}
  ...
  return (
    <div className="space-y-4">
      ...
      <form onSubmit={createUser} className="grid gap-2 rounded-xl border border-slate-200 bg-white p-4 md:grid-cols-2">
        ...
        <button className="rounded bg-brand-700 px-3 py-2 text-white md:col-span-2">Criar usuario</button>
      </form>
            ...
            {users.map((row) => (
              <tr key={row.id} className="border-t border-slate-200">
                ...
                <td className="px-3 py-2">
                  <button type="button" onClick={() => openEditModal(row)} className="rounded bg-slate-800 px-2 py-1 text-xs text-white">
                    Editar
                  </button>
                </td>
              </tr>
